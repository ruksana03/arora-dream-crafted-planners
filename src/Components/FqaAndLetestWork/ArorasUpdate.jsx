    ...
    return (
        <div className="mx-28 my-12">
            ...
            <div className="text-center">
                ...
                <button className="btn text-black border-2 border-[#FF9B23]  hover:bg-gradient-to-r from-[#FF5107] from-10% via-[#FF5107] via-30% to-[#FF9B23] to-90% p-0.5 w-1/2 hover:text-white text-base font-bold">Join US</button>
            </div>
        </div>
    );
};
