    ...
    return (
        <div className="flex flex-col md:flex-row lg:flex-row gap-6 bg-[#F7F7F7] hover:border-2 border-[#FFB12B] px-3 py-4">
            <div className="w-3/5 h-full flex">
                <p className=" md:absolute lg:absolute z-10 py-7 px-5 text-2xl font-extrabold text-white bg-gradient-to-r from-[#FF5107] from-10% via-[#FF5107] via-30% to-[#FF9B23] to-90%">{date} <br /> {month}</p>
